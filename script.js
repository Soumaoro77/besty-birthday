...
const angle = 360 / videoItems.length;
const radius = 420;
...
// Lecture automatique de la vidéo au premier plan
function updateVideos() {
    ...
    videoItems.forEach(item => {
        ...
        if (z > bestZ) {
            bestZ = z;
            bestVideo = item.querySelector("video");
        }
...
setInterval(updateVideos, 200);
let startX=0;

document.querySelector(".videoGallery3d").addEventListener("touchstart",e=>{

startX=e.touches[0].clientX;

});

document.querySelector(".videoGallery3d").addEventListener("touchend",e=>{
